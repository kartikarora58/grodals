    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="myform">
          ...
          <div class="form-group">
           Logo:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img width="auto" height="auto" src="" id="logo">
          </div>
           <b><hr size="50px"></b>
          <div class="form-group">
  ...
  $('#refresh').click(function()
  {
   ...
   $('.view').click(function(){
            ...
            console.log(user_id);          
              $.get('/training/grodal/admin/check/'+user_id,function(data){
                ...
                $('#logo').attr('src','{{url("/public/image")}}'+'/'+data.user.logo);
              ...
              else
              {
                ...
                $.each(x, function (index, value) {     
                 ...
                 $('#gallery').attr('src','{{url("/public/image")}}'+'/'+value);
                 });
              }
   ...
   $('.approval').click(function(){
    ...
    $('.reject').click(function(){
       var id=$(this).val();
       console.log(id);
       $.get('/training/grodal/admin/reject/'+id,function(data){
        $('#success').show();
                 $('#success').text('Listing Rejected.Please Refresh the page.');
       });
       $('#mymodal').modal('toggle');
